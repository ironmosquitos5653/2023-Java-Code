...
public class MovePayoutCommand extends CommandBase {
  /** Creates a new MovePayoutCommand. */
  private ExtenderSubsystem m_extenderSubsystem;
  private double m_extenderPosition;

  public MovePayoutCommand(ExtenderSubsystem extenderSubsystem, double extenderPosition) {
  ...
  public boolean isFinished() {
    return m_extenderSubsystem.getPayoutEncoderPosition() > m_extenderPosition;
  }
}
